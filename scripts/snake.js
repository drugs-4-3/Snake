...
function Snake() {
	...
	this.checkLocation = function () {
		if (this.tail[this.total-1].x > 600 - scl)
			this.tail[this.total-1].x = 0;
		else if (this.tail[this.total-1].x < 0)
			this.tail[this.total-1].x += 600;

		if (this.tail[this.total-1].y > 600 - scl) 
			this.tail[this.total-1].y = 0;
		else if (this.tail[this.total-1].y < 0) 
			this.tail[this.total-1].y += 600;
	}
